...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-cream)' }}>
      ...
      <header className="relative z-10 px-6 md:px-12 py-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#how-it-works" className="link-hover text-sm">How it works</a>
          </nav>
        </div>
      </header>
            ...
            >
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="card text-center py-8">
                  ...
                  <h3 className="font-display text-lg font-medium mb-2">Spotify</h3>
                  <p className="text-sm" style={{ color: 'var(--text-medium)' }}>Your playlists</p>
                </div>
                ...
                <div className="card text-center py-8">
                  ...
                  <h3 className="font-display text-lg font-medium mb-2">Tidal</h3>
                  <p className="text-sm" style={{ color: 'var(--text-medium)' }}>Hi-Fi destination</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features */}
      <section id="features" className="relative z-10 px-6 md:px-12 py-24" style={{ background: 'var(--bg-warm)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="heading-lg">
              ...
              <br />
              <span className="italic" style={{ color: 'var(--coral)' }}>switch with ease</span>
            </h2>
          </div>
